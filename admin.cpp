...
//        type:saving
        ...
        {
            out<<ui->account_input_lineEdit->text()<<"/"<<ui->password_input_lineEdit->text()<<"//"<<"1"<<"///"<<str10<<"\n"<<Qt::endl;
        }
        else if(ui->type_comboBox->currentIndex() ==1)
        {
//            credit card
            out<<ui->account_input_lineEdit->text()<<"/"<<ui->password_input_lineEdit->text()<<"//"<<"2"<<"///"<<str10<<"\n"<<Qt::endl;
        }
...
//update account
        ...
        if(ui->type_comboBox->currentIndex() == 0)
        {
            out1<<ui->account_input_lineEdit->text()<<"/"<<"1"<<"//"<<"0.00"<<"///"<<str10<<"\n"<<endl;
        }
        else if(ui->type_comboBox->currentIndex() ==1)
        {
            out1<<ui->account_input_lineEdit->text()<<"/"<<"2"<<"//"<<"0.00"<<"///"<<str10<<"\n"<<endl;
        }
        file.close();
