...
{
//    int jieguo = 0;
//format:account_name/account_type//date_balance
...
void Custom::saveMoney()
{
       ...
       // qDebug()<<Filepath;
        ...
        out<<input_account<<"/"<<"1"<<"//"<<number<<"///"<<str10<<"\n"<<endl;
        file.close();
        ...
        {
             out1<<input_account<<"/"<<"1"<<"//"<<QString::number(fnum3)<<"///"<<str10<<"\n"<<endl;
        }
        else if(ui->type_show_label->text() == "credit")
        {
             out1<<input_account<<"/"<<"2"<<"//"<<QString::number(fnum3)<<"///"<<str10<<"\n"<<endl;
        }
        file.close();
}
void Custom::getMoney()
{
       ...
       // qDebug()<<Filepath;
        ...
        QDate currentdate = QDate::currentDate();
        QString str10 = currentdate.toString("yyyy-MM-dd");
        out<<input_account<<"/"<<"2"<<"//"<<number<<"///"<<str10<<"\n"<<endl;
        file.close();
...
//    format:name/passward//type(1save2credit3admin)///date
    while(!file.atEnd()) {
//        QString tof = 0;
        QByteArray line = file.readLine();
        QString str(line);
